...
\begin{longtable}{>{\raggedright\arraybackslash}p{\dimexpr 0.33\linewidth -2\tabcolsep-1.5\arrayrulewidth}>{\raggedleft\arraybackslash}p{\dimexpr 0.33\linewidth -2\tabcolsep-1.5\arrayrulewidth}>{\raggedright\arraybackslash}p{\dimexpr 0.33\linewidth -2\tabcolsep-1.5\arrayrulewidth}}
...
\midrule\addlinespace[2.5pt]
\multicolumn{3}{>{\raggedright\arraybackslash}m{1.32\linewidth}}{Bibliographic references} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
