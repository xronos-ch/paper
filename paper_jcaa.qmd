...
XRONOS <https://xronos.ch> is a new open data infrastructure that aims to provide access to published radiocarbon dates and other chronometric data from any period, anywhere in the world.
...
The 'Radiocarbon Palaeolithic Europe Database' [@Vermeersch2020], despite the name, includes a significant number of TL (1177 items), OSL (1086 items), ESR, Th/U and AAR.
...
Other than this, we are not aware of any other significant published open datasets.
