...
<!--
* [ ] First draft:
  * [x] Introduction [530/500]
  * [ ] State of the art [2000]
    * [x] Compilations of radiocarbon dates [1000]
    * [x] Open data infrastructures [500]
    * [x] Beyond radiocarbon [850/500]
  * [ ] Concept [1000]
    * [x] Inherits a common structure from RADON
    * [x] Design goals [250/250]
...
<!-- TODO: lab databases don't go out of date, but have arbitary coverage? -->

* The coverage of these databases is uneven, systematically biased, and duplicative of each other [@CITE Africa paper]?
...
## Open data infrastructures {#sec-global-compilations}
...
<!-- TODO: MH, update and turn into prose -->
...
This is also typically present in many other forms of systematic compilation work in archaeology, for example site gazetteers [@CITE].
...
Typological dates on one class of object may well clash with other classes of object, or for that matter with scientific dates, but without this kind of metadata such inconsistencies are difficult to resolve.
Similarly the real calendar range corresponding to a typological date (e.g. "Late Neolithic") can be interpreted in multiple ways depending on the region and intentions of the expert making the determination.
...
As the sustainability of scientific software and data infrastructures is a pressing problem, in the future it may be desirable to support further decentralisation through, for example, a federated server-server model [@CITE].
