...
* Chronology is the backbone of the archaeological record – we need it to be open!

<!-- Prehistory of open radiocarbon 
TODO: shorten -->
...
* Move to open compilations in the last ~10 years
...
* Where do radiocarbon dates come from and how are they published?
* History of systematic compilations
* Summary of existing databases
  * FIGURE: graph of number of dates/databases through time
  * FIGURE: map of radiocarbon database coverage
  * TABLE: radiocarbon databases
* Problems with current state of the art

### Open data infrastructures


The profusion of radiocarbon compilations over the last decade has naturally prompted many to think more globally:

- The first available radiocarbon 'metadatabase' was **c14bazAAR** [@CITE], an R package that provides an index of openly published radiocarbon databases and a common interface for retrieving them and performing basic data cleaning.
