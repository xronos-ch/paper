...
For radiocarbon dates, for example, we follow established conventions [@Millard2014] in recording the type (e.g. charcoal, charred seed) and, where applicable, taxonomic designation (e.g. TODO, TODO<!--sorry, not fully clear what goes here. MH.-->) of the organic material used for dating.
...
However, we hope it will provide a foundation for ... ? <!-- TODO Not fully clear what need to go here. MH. -->
...
Moving beyond archaeology, Wikidata (<https://wikidata.org>) already includes many of the concepts represented in the XRONOS model (e.g. archaeological sites, Q<!-- TODO Eg Q39671? MH.-->).
...
Such usages could look like, for example, using a XRONOS URL as a canonical representation of a single radiocarbon date (e.g. <!-- TODO Not fully clear what need to go here. MH. -->).
...
Controlled vocabularies are used in a number of places in the data model (@FIG), and we use thesauri to automatically standardise these fields as much as possible.
...
<!--In parallel, the planned ERC Consolidator Grant Project ESTER, focusing on the estimation of population development in prehistory, will over the next five years play a crucial role in supporting the continuation and further development of the XRONOS database, ensuring its sustainability and fostering interdisciplinary collaboration.
-->
