...
The data and R code used to produce our analysis of the state of the art in radiocarbonc compilation, including all the figures presented here, can be accessed via Zenodo at (<!-- TODO: add link -->*link omitted for blind review, included in submission materials*)
